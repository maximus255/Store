...
- (void)viewDidLoad1 {
   // [super viewDidLoad];
    ...
    passiveColor = [NSColor colorWithDeviceRed:0.5f green:0.5f blue:0.5f alpha:1.0f];
    disableColor = [NSColor colorWithDeviceRed:0.35f green:0.35f blue:0.35f alpha:1.0f];
    ...
    dispatch_async(previewQueue,
                   ^{
                       ...
                       dispatch_async(dispatch_get_main_queue(), ^{
                           ...
                           //[Max 2021.06.18
                           //setup readwrite permissions
                           //! it already should be setup earlier
