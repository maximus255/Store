...
- (void)viewDidLoad1 {
   // [super viewDidLoad];
    ...
    // Do view setup here.
    activeColor = [NSColor colorWithDeviceRed:0 green:0.0f blue:0.0f alpha:1.0f];
    passiveColor = [NSColor colorWithDeviceRed:0.45f green:0.45f blue:0.45f alpha:1.0f];
    disableColor = [NSColor colorWithDeviceRed:0.50f green:0.50f blue:0.50f alpha:1.0f];
