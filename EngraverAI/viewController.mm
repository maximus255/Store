...
- (void)viewDidLoad1 {
   // [super viewDidLoad];
    ...
    // Do view setup here.
    activeColor = [NSColor colorWithDeviceRed:1 green:1.0f blue:1.0f alpha:1.0f];
    passiveColor = [NSColor colorWithDeviceRed:0.75f green:0.75f blue:0.75f alpha:1.0f];
    disableColor = [NSColor colorWithDeviceRed:0.40f green:0.40f blue:0.40f alpha:1.0f];
   ...
   /* //intro_Menu
    [[intro_Menu cell] setBackgroundStyle:NSBackgroundStyleRaised];
    [[license_Menu cell] setBackgroundStyle:NSBackgroundStyleRaised];
    [[destination_Menu cell] setBackgroundStyle:NSBackgroundStyleRaised];
    [[findPSD_Menu cell] setBackgroundStyle:NSBackgroundStyleRaised];
    [[installing_Menu cell] setBackgroundStyle:NSBackgroundStyleRaised];
    [[finish_Menu cell] setBackgroundStyle:NSBackgroundStyleRaised];
    */
