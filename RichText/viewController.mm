...
- (void)viewDidLoad1 {
   // [super viewDidLoad];
    ...
    // Do view setup here.
    activeColor = [NSColor colorWithDeviceRed:0.0f green:0.0f blue:0.90f alpha:1.0f];
    passiveColor = [NSColor colorWithDeviceRed:0.85f green:0.85f blue:0.85f alpha:1.0f];
    disableColor = [NSColor colorWithDeviceRed:0.0f green:0.0f blue:0.0f alpha:1.0f];
