...
- (void)viewWillAppear1
{
    ...
    [[congratulationText cell] setBackgroundStyle:NSBackgroundStyleRaised];//NSBackgroundStyleDark];//NSBackgroundStyleLowered];//NSBackgroundStyleRaised];
    [[pathText cell] setBackgroundStyle:NSBackgroundStyleRaised];//NSBackgroundStyleDark];//NSBackgroundStyleLowered];//NSBackgroundStyleRaised];
}
@end
