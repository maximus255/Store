...
- (void)viewDidLoad1 {
   // [super viewDidLoad];
    ...
    [self.view.window setBackgroundColor:[NSColor colorWithDeviceRed:0 green:0 blue:0 alpha:1.0f]];
    
    // Do view setup here.
    activeColor = [NSColor colorWithDeviceRed:1.0f green:1.0f blue:1.0f alpha:1.0f];
...
-(void)ShowCurrentPage
{
    ...
    switch (_State)
    {
        ...
        case STATE_FIND:
        {
            ...
            destination_Menu.textColor = activeColor;
